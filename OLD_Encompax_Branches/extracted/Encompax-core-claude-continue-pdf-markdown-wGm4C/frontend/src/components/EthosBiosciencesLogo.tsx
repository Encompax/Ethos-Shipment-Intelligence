...
/**
 * Ethos Biosciences logo icon — precise SVG recreation of the DNA helix mark.
 *
 ...
 *   <img src="/ethos-logo.png" alt="Ethos Biosciences" height={size} style={{ filter: "brightness(0) invert(1)" }} />
 */
