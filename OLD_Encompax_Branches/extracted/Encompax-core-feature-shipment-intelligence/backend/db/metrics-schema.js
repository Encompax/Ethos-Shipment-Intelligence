 ...
 * 
 * Database tables for metric storage and integration tracking.
 * Metrics are normalized data points from capability-based integrations.
 */
...
function initMetricsSchema(db) {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS metrics (
      ...
      source TEXT NOT NULL,                   -- 'hris', 'erp', 'quality_operations', etc
      metric_key TEXT NOT NULL,               -- 'employee_count_active', 'revenue_month_to_date', etc
      
      value REAL,                             -- numeric value (employee_count_active: 127, revenue: 425000)
